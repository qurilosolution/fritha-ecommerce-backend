...
const categoryResolver = {
  ...
  Mutation: {
    createCategory: async (_, { name, description, imageUrl, userId }) => { // Include userId
      console.log("Received args in createCategory:", { name, description, imageUrl, userId });
      ...
      try {
        const categoryData = {
          ...
          description,
          imageUrl: [], // Initialize as an empty array
          userId, // Include userId in category data
        };
